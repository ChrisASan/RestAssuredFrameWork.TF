...
//		I Don't Need To Put All These Key/Values For The Product, Only The Key/Values I Want To Update
		updatePayload.put("id", "5322");
		updatePayload.put("name", "Amazing PET  by CAS 2");
		updatePayload.put("price", "99");
		updatePayload.put("description", "The best pet for amazing programmers.");
