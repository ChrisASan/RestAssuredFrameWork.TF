...
//		Validations 
		...
		Assert.assertEquals(productID, "5322");
		
		String productName = jp.get("name");
		System.out.println("Product Name:" + productName);
		Assert.assertEquals(productName, "Amazing PET  by CAS");
		
		String productDesc = jp.get("description");
		System.out.println("Product Description:" + productDesc);
		Assert.assertEquals(productDesc, "The best pet for amazing programmers.");
