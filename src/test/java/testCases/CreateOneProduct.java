...
//	Payload/Body: 
//	{
//	    "name": "Amazing PET  by CAS",
//   	"price": "199",
//   	"description": "The best pet for amazing programmers.",
//   	"category_id": 2
//	}

	HashMap<String, String> createPayload; // Saving time by not converting it to a JSON Path and having to do other
											// things. Converting the CreateProductPayload.json to map
	String firstProductID;

	public Map<String, String> createPayLoadMap() { // It's in its own method because it needs to be accessed by other
													// methods for comparisons

		createPayload = new HashMap<String, String>();

		createPayload.put("name", "Amazing PET  by CAS");
		createPayload.put("price", "199");
		createPayload.put("description", "The best pet for amazing programmers.");
...
//		given:
				given().baseUri("https://techfios.com/api-prod/api/product")
						.header("Content-Type", "application/json; charset=UTF-8")
						.header("Authorization", "Bearer Authorization").body(createPayLoadMap()) // One way to do the
																									// body
...
//		.log().all() //If I want to use it
						...
						.basic("demo@techfios.com", "abc123") // Basic Auth (if I do this one)
						.relaxedHTTPSValidation().
...
//		.log().all() //If I want to use it
						.baseUri("https://techfios.com/api-prod/api/product")
						.header("Content-Type", "application/json; charset=UTF-8").queryParam("id", firstProductID)
						.relaxedHTTPSValidation().
